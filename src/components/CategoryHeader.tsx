...
function Kategori() {
  return (
    <>
      {itemData.map((val, i) => (
        <Grid item xs={6} sm={6} md={3} lg={3} xl={3} sx={{ mt: -5, mb: 5, pl: 2 }} key={i}>
          <Card
            sx={{
              width: '100%',
              background: '#3e3e3ee0',
          ...
          >
            <CardActionArea>
              <CardMedia
                ...
                sx={{
                  objectFit: 'fill',
                  height: { xs: '110px', sm: '110px', md: '230px' },
                }}
              />
              <Typography
                variant="h4"
        ...
        <Grid item xs={6} sm={6} md={3} lg={3} xl={3} sx={{ mt: -5, mb: 5, pl: 2 }} key={i}>
          <Card
            sx={{
              ...
              color: 'white',
              borderRadius: '6px',
              boxShadow: '4px 6px 17px 0px #8c8e95d1',
            }}
          >
            <CardActionArea>
              <CardMedia
                ...
                sx={{
                  objectFit: 'fill',
                  height: { xs: '140px', sm: '140px', md: '250px', lg: '250px' },
                }}
              />
              <Typography
                variant="h4"
                ...
                sx={{
                  ...
                  textAlign: 'center',
                  position: 'absolute',
                  background: 'linear-gradient(45deg, #0a1c24, #0a322e75,#0d2632)',
                  padding: '1px 7px 1px 7px',
                  fontWeight: 'bold',
                  borderRadius: '6px',
                  width: '100%',
